...
(() => {
  ...
  const stylesheet =
    ...
    // Unconditional touch-action:none here blocked normal page scrolling
    // on a read-only share link the moment a finger landed on any photo —
    // only an editable (reframable) slot needs to own touch gestures.
  ...
  class ImageSlot extends HTMLElement {
    ...
    constructor() {
      ...
      // Ungated, this would let a read-only share-link visitor tap an empty
      // slot and get a native file picker with nowhere to save the result —
      // gate it the same as the other mutating controls.
